      ...
      <el-row>
        <el-col :span="24">
          <el-form-item label="身份证号码" prop="vCardid">
            <el-input v-model.trim="form.vCardid" clearable placeholder="请输入身份证号码" maxlength="18" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="24">
          <el-form-item label="车牌号" prop="carNumber">
            <el-input v-model.trim="form.carNumber" clearable placeholder="请输入车牌号" onblur="this.value=this.value.toUpperCase()" maxlength="10" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
...
<script setup name="visit">
    ...
    import { scanAddVisit,getVisitByTelephone} from "@/api/tk_custom/visit";
    ...
    function submitForm() {
        proxy.$refs["visitRef"].validate(valid => {
            if (valid) {
                scanAddVisit(form.value).then(response => {
